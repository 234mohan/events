...
const ActiveEventRegistrationDetails = props => {
  ...
  const renderRegistrationClosed = () => (
    <div className="closed-container">
      <img
        src="https://assets.ccbp.in/frontend/react-js/eventgs-registrations-closed-img.png"
  ...
  const renderYetToRegister = () => (
    <div className="yet-to-registered-container">
      <img
      ...
      <p className="register-description">
        A live performance brings so much to you fall totally in love with this
        beautiful art form.
      </p>
